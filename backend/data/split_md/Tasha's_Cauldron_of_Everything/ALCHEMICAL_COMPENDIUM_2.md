...
metal to another. When found, the book contains the 
...
If you spend 1 minute studying the book, you 
can expend 1 charge to replace one of your 
prepared wizard spells with a different spell in 
the book. The new spell must be of the trans­
mutation school. 
• As an action, you can touch a nonmagical object 
that isn't being worn or carried and spend a num­
ber of charges to transform the target into another 
object. For 1 charge, the object can be no larger 
than 1 foot on a side. You can spend additional 
charges to increase the maximum dimensions by 
2 feet per charge. The new object must have a gold 
value equal to or less than the original.
