...
_Source: Mordenkainen's Tome of Foes.pdf, page 202_
...
Damage Vulnerabilities thunder INT 
2 (-4) WIS 
21 (+5) CHA 
18 {+4) 
Damage Resistance s cold, fire, lightning; bludgeoning, 
...
the check is an automatic success. On a successfu l save, the 
...
and structures (included in Earth-Shaking Movement). Multiattack. The zaratan makes two attacks: one with its bite 
