...
_Source: Mordenkainen's Tome of Foes.pdf, page 166_

HELLFIRE ENGINE 
Hellfire engines are semiautonomo us bringers of de­
...
24 (+7) INT 
2 (-4) 
Saving Throws Dex +8, Wis +5, Cha +O WIS 
10 (+O) CHA 
l (-5) 
...
a successfu l save, the creature is pushed 5 feet to the nearest 
...
the creature is also restrained until it's no longer in the same • space as the hellfire engine. While restrained in this way, the 
