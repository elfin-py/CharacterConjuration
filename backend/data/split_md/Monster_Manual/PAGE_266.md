...
_Source: Monster Manual.pdf, page 266_
...
summon them as warriors, but others enlist the 
salamanders for their crafting skills, or bind them to 
forges and ovens to generate limitless heat. Medium elemental, neutral evil 
...
14 (+2) CON 
11 (+0) 
Damage Vulnerabilities cold INT 
7 (-2) WIS 
10 (+0) CHA 
8 (-1) 
...
3 (1d4 + 1) bludgeon ing damage plus 3 (1d6) fire damage.
