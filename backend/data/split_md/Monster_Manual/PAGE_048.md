...
_Source: Monster Manual.pdf, page 48_

DEATH K'NIGHT 
When a paladin that falls from gFace dies without 
...
skull with malevolent pinpoints of light burning in its 
eye sockets. 
Eldritch Power. The death knight retains the ability 
to cast divine spells. However, no death knight can 
use its magic to heal. A death knight also attracts and 
command s lesser undead, although death knights that 
serve powerful fiends might have fiendish followers 
instead. Death knights often use warhorse skeletons 
and nightmares as mounts. 
...
Damage Immunities necrotic, poison WIS 
16 (+3) CHA 
18 (+4) 
...
with spell attacks). It has the following paladin spells prepared: 1st level (4 slots): command, compelled duel, searing smite 
2nd level (3 slots): hold per-son, magic weapon 
