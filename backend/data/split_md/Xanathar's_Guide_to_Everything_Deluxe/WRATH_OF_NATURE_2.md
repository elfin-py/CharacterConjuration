...
within range. The s pirits cause trees, rocks, and grasses 
...
can use an action to make a Strength (Athletics) check 
...
see in the cube. Make a ranged s pell attack against the 
target. On a bit, the target takes 3d8 nonmagical blud-
