...
Weapons with special rules are described
here.
Lance. Vou have disadvantage
when you use a lance
to attack a target within 5 feet of you. Also, a lance
requires two hands to wield when you aren't mounted.
Net. A Large or smaller creature
hit by a net is
restrained
until it is freed. A net has no effect on
PART 1 I EQUIPMENT
creatures
that are formless, or creatures
that are Huge
or larger. A creature
can use its action to make a DC 10
Strength
...
regardless
of the number of attacks you can
normally make.
