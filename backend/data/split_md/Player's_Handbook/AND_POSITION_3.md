...
is an instant response
to a trigger of some kind, which
can occur on your turn ar on someone else's. The
opportunity
attack, described
later in this chapter, is the
most common type of reaction.
When you take a reaction, you can't take another one
until the start of your next turno If the reaction interrupts
another creature's
turn, that creature can continue its
