...
Range: 120 feet
Components:
5, M (a glowing stick of incense or a
crystal viaI filled with phosphorescent
material)
Duration: Concentration, up to 1 minute
Vou create a twisting pattern of colors that weaves
...
damage or if someone e1se uses an action to shake the
