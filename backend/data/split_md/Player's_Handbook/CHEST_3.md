...
Range: Touch
Components:
V,S, M (an exquisite chest, 3 feet by 2 feet
by 2 feet, constructed from rare materiaIs worth at
least 5,000 gp, and a Tiny replica made from the same
materiais worth at least 50 gp)
Duration: Instantaneous
Vou hide a chest, and ali its contents, on the Ethereal
Plane. Voumust touch the chest and the miniature
...
chesl. lt appears in an unoccupied space on the ground
within 5 feet of you. Vou can send the chest back to the
...
destroyed, ar ifyou choose to end the spell as an action.
