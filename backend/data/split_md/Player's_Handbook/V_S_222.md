...
appears on
the ground in an unoccupied space ofyour choice
within range. Vou decide the creature's
appearance,
...
ride the steed. The creature
uses the statistics for a
...
an action to dismiss it ar if the steed takes any damage.
