...
Voucraft an illusion that takes root in the mind of a
...
lO-foot cube and that is perceivable only to the target
...
it slipped, ar a strong wind might have knocked it off.
...
pool of acid. ar lava can burn the target. Each round on
your turn. the phantasm can deal Id6 psychic damage
to the target if it is in the phantasm's area ar within 5
