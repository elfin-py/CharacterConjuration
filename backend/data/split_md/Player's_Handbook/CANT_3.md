...
Only
another creature
that knows thieves' cant understands
such messages.
lt takes four times longer to convey sue h
a message than it does to speak the same idea plainly.
In addition, you understand
a set of secret signs and
symbols used to convey short, simple messages,
such
as whether an area is dangerous
or the territory of a
