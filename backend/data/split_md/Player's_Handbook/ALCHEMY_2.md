...
can temporarily alter the physical properties
of one
nonmagical
object, changing it from one substance
into
another. Vou perform a special alchemical procedure
on one object composed entire1y of wood, stone (but not
a gemstone), iron, copper, or silver, transforming
it into
a different one of those materiais.
For each 10 minutes
you spend performing
the procedure, you can transform
